...
class PupilDataHandler:
    ...
    def load_from_dataframe(self, pupil_dataframe: pd.DataFrame):
        ...
        self.pupil_data = PupilLabsDataClass(
    ...
    def convert_to_unix_timestamps(self, pupil_recording_info_json: dict):
        ...
        self.pupil_data.timestamps *= 1e9
        # self.pupil_data.timestamps = (
        #     self.pupil_data.timestamps
        #     - pupil_recording_info_json["start_time_synced_s"]
        #     + pupil_recording_info_json["start_time_system_s"]
        # )
    ...
    def get_eye_data(self, eye_str: str):
        ...
        this_eye_logical_indicies = np.logical_and(
            self.pupil_data.eye_d == eye_d, self.pupil_data.method != "2d c++"
        )
        return PupilLabsDataClass(
            ...
            pupil_center_normal_x=self.pupil_data.pupil_center_normal_x[
                this_eye_logical_indicies
            ],
            pupil_center_normal_y=self.pupil_data.pupil_center_normal_y[
                this_eye_logical_indicies
            ],
            pupil_center_normal_z=self.pupil_data.pupil_center_normal_z[
                this_eye_logical_indicies
            ],
        )
